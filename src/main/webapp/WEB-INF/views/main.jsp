    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/img/공간.jpg" class="d-block w-100" alt="..." style="height: 650px;">
            </div>
            <div class="carousel-item">
                <img src="/img/스튜디오.jpg" class="d-block w-100" alt="..." style="height: 650px;">
            </div>
            <div class="carousel-item">
                <div class="carousel-caption" style="margin-bottom: 120px;">
                    ...
                    <div class="playstore">
                        <img src="img/google.png" alt="android" id="google" onclick="playstore();">
                        <img src="img/apple.png" alt="apple" id="apple" onclick="applestore();">
                    </div>
                </div>
                <img src="/img/우주.jpg" class="d-block w-100" alt="..." style="height: 650px;">
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="section">
                ...
                <div class="section1" onclick="location.href='main.html'" style="cursor:pointer;">
                    <div class="con1">
            ...
            <div id="banner">
                <img src="/img/베너.JPG" alt="banner" id="poster" onclick="location.href='#'">
            </div>
        </div>
    </div>
