		...
		<div class="search_box">
			<ul class="search_box_ul">
				<li>
					...
					</script> &nbsp&nbsp~&nbsp&nbsp <input type="text" id="datepicker2">
					<script>
						$(function() {
							//input을 datepicker로 선언
							$("#datepicker2")
				...
				<li>
					<p>예약상태</p> <label id="check_label"><input type="checkbox">전체</label>
					<label id="check_label"><input type="checkbox">예약완료</label>
					<label id="check_label"><input type="checkbox">예약대기</label>
					<label id="check_label"><input type="checkbox">예약취소</label>
			</ul>
