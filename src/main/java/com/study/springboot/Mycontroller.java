...
//	one2one answer 작성
	...
	@ResponseBody
	public String contentAction(@RequestParam("notice_title") String notice_title,
...
//		------------------------------------------------------------------
	...
	public String community_infoAction(@RequestParam("commu_info") String reply_content,
			...
			@RequestParam("communty_number") String community_number, replyDto dto, HttpServletRequest request,
			Model model) {
	...
	public String space_info(@RequestParam("hostenter_number") int hostenter_number, Model model) {
