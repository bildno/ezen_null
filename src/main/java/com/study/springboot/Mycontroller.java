...
public class Mycontroller {
	...
	public String ad_member(@RequestParam(value = "page", required = false) String page,
			...
			@RequestParam(value = "search_contents", required = false) String search_contents, Model model) {
		...
		List<memberDto> ad_member_page = imemberDao.ad_member_page(String.valueOf(startRowNum),
	...
	public String ad_one2one_answer(@RequestParam("one2one_number") String one2one_number, HttpServletRequest request,
			Model model) {
...
//	one2one answer 작성
	...
	public String one2one_answer_write(@RequestParam("one2oneanswer_content") String one2oneanswer_content,
			@RequestParam("one2one_number") String one2one_number,
			@RequestParam("one2one_member_id") String one2one_member_id, HttpServletRequest request, Model model,
		...
		int result = one2one_answerService.one2one_answer_write(one2oneanswer_content, one2one_number,
				one2one_member_id);
	...
	public String ad_one2oneanswer_update(@RequestParam("one2oneanswer_content") String one2oneanswer_content,
			@RequestParam("one2oneanswer_one2one_number") String one2oneanswer_one2one_number, Model model) {
	...
	public String ad_notice(@RequestParam(value = "page", required = false) String page, Model model) {
	...
	@ResponseBody
	public String ad_notice_update(@RequestParam("notice_title") String notice_title,
			@RequestParam("notice_number") String notice_number,
			@RequestParam("notice_contents_number") String notice_contents_number,
			@RequestParam("notice_content") String notice_content, noticeDto dto) {
...
//	notice확인
	...
	public String ad_notice_write(@RequestParam("notice_number") String notice_number, HttpServletRequest request,
			Model model) {
...
//	notice 검색
	...
	public String ad_noticesearch(@RequestParam(value = "page", required = false) String page,
			@RequestParam("search_type") String search_type, @RequestParam("search_contents") String search_contents,
			Model model) {
		...
		List<noticeDto> notice_list = noticeDao.noticepage(String.valueOf(startRowNum_notice),
				String.valueOf(endRowNum_notice));
		System.out.println(notice_list);
...
//	FAQ 확인, 삭제
	...
	public String ad_FAQ_write(@RequestParam("faq_number") String faq_number, HttpServletRequest request, Model model) {
...
//	FAQ 수정
	...
	public String ad_FAQ_update(@RequestParam("faq_number") String faq_number,
			@RequestParam("faq_title") String faq_title, @RequestParam("faq_content") String faq_content,
	...
	public String ad_FAQ(@RequestParam("faq_number") String faq_number, HttpServletRequest request, Model model) {
...
//	FAQ 작성
	...
	public String ad_FAQ_writeAction(@RequestParam("faq_title") String faq_title,
			@RequestParam("faq_content") String faq_content, HttpServletRequest request, Model model, faqDto dto) {
	...
	public String mylist(@RequestParam(value = "mycommu_page", required = false) String mycommu_page,
			...
			@RequestParam(value = "myreply_page", required = false) String myreply_page, HttpServletRequest request,
			Model model) {
		...
		// row 1~5 까지...
		List<communityDto> mycommu_pagelist = icommunityDao.mycommu_page(String.valueOf(startRowNum_community),
				String.valueOf(endRowNum_community), member_id);
		List<reviewDto> myreview_pagelist = ireviewDao.myreview_page(String.valueOf(startRowNum_review),
				String.valueOf(endRowNum_review), member_id);
		List<replyDto> myreply_pagelist = ireplyDao.myreply_page(String.valueOf(startRowNum_reply),
				String.valueOf(endRowNum_reply), member_id);
...
//	------------------------------------------------------------------
	...
	public String notice(@RequestParam(value = "page_notice", required = false) String page_notice,
			@RequestParam(value = "page_faq", required = false) String page_faq, HttpServletRequest request,
			Model model) {
		/*
		...
		List<noticeDto> noticelist = noticeDao.noticepage(String.valueOf(startRowNum_notice),
				String.valueOf(endRowNum_notice));
...
//		------------------------------------------------------------------
	...
	public String searchAction(@RequestParam("search") String search, Model model) {
	...
	public String spacelist_host(HttpServletRequest request, Model model) {
	...
	public String space_info_host(HttpServletRequest request, @RequestParam("host_name") String hostenter_img_title,
			Model model) {
		HttpSession session = request.getSession();
		String member_id = (String) session.getAttribute("member_id");
	...
	public String community(@RequestParam(value = "contents_number") String contents_number,
		...
		// row 1~5 까지...
		List<communityDto> communitylist = icommunityDao.community_page(String.valueOf(startRowNum_community),
				String.valueOf(endRowNum_community), contents_number);
	...
	public String community_writeAction(@RequestParam("commu_title") String community_title,
			@RequestParam("commu_contents_number") int contents_number,
			@RequestParam("commu_content") String community_content, @RequestParam("commu_name") String member_name,
			HttpServletRequest request, Model model) {
	...
	public String community_info(@RequestParam("community_number") String community_number, HttpServletRequest request,
	...
	public String community_infoAction(@RequestParam("commu_info") String reply_content,
			// form안에 있어서 community_number 가져올 수 있음
			@RequestParam("community_number") String communty_number, replyDto dto, HttpServletRequest request,
			Model model) {
	...
	public String spacerent(@RequestParam("contents_number") String contents_number, Model model) {
	...
	public String space_info(@RequestParam("hostenter_number") int hostenter_number,
			@RequestParam("hostenter_name") String hostenter_name, Model model) {
	...
	@ResponseBody
	public String zzim_doAction(@RequestParam("hostenter_number") String hostenter_number, HttpServletRequest request,
			Model model) throws Exception {
	...
	public String uploadMultiFileOk(@RequestParam("host_name") String host_name_,
			@RequestParam("room") int host_contents_number_, @RequestParam("host_onerow") String host_onerow_,
			...
			@RequestParam("addr2") String host_location_detail_, @RequestParam("host_price") int host_price_,
			@RequestParam("host_bnumber") int host_bnumber_, @RequestParam("host_headcount") int host_headcount_,
		...
		try {
			result = hostenterService.insert_hostenter(upload_url_title, host_contents_number, host_name, host_des,
					host_caution, host_zip, host_location, host_location_detail, host_price, host_headcount, member_id,
					host_bnumber, host_onerow);
	...
	public String udateuploadMultiFileOk(@RequestParam("hostenter_number") int hostenter_number,
			@RequestParam("host_name") String host_name_, @RequestParam("room") int host_contents_number_,
			@RequestParam("host_onerow") String host_onerow_, @RequestParam("host_des") String host_des_,
			@RequestParam("host_caution") String host_caution_, @RequestParam("host_price") int host_price_,
			@RequestParam("host_bnumber") int host_bnumber_, @RequestParam("host_headcount") int host_headcount_,
		...
		try {
			...
			result = hostenterService.update_space(upload_url_title, host_name, host_contents_number, host_onerow,
					host_des, host_caution, host_price, host_bnumber, host_headcount, hostenter_number);
